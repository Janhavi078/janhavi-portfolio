        ...
        <div className="hero-content">
          ...
          >
            ...
            <div style={{ display: "flex", gap: "15px", marginTop: "15px", flexWrap: "wrap" }}>
              ...
              <a
                href="https://www.instagram.com/blush_borne?igsh=bWVxODlwb3g4eDYy"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-cv-download"
              >
                <span className="btn-glitch-text">INSTAGRAM</span>
              </a>

              <a
                href="https://www.linkedin.com/in/janhavi-kashyap-385997277?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-cv-download"
              >
                <span className="btn-glitch-text">LINKEDIN</span>
              </a>
